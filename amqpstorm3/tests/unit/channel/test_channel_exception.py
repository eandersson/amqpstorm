...
class ChannelExceptionTests(TestFramework):
    ...
    @mock.patch('amqpstorm3.Channel._build_message',
    ...
    def test_channel_build_inbound_raises_in_loop(self):
        ...
        with mock.patch('amqpstorm3.Channel._build_message',
